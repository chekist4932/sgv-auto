                                ...
                                <div className="grid grid-cols-6 gap-2">
                                    {images.map((image, index) => (
                                        <div
                                            ...
                                            className={`aspect-video rounded-lg overflow-hidden cursor-pointer border-2 transition-colors ${currentImageIndex === index ? 'border-red-500' : 'border-transparent hover:border-gray-300'}`}
                                        >
                                            <img
                                                src={image.url}
                                                alt={image.alt}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center text-gray-600 dark:text-gray-300">
                                    ...
                                    <span>Год выпуска: {generation.years}</span>
                                </div>
                                <div className="flex items-center text-gray-600 dark:text-gray-300">
                                ...
                                <div className="flex items-center text-gray-600 dark:text-gray-300">
                                    ...
                                    <span>Коробка передач: {spec.transmission}</span>
                                </div>
                                {spec.drivetrain && (
                                    <div className="flex items-center text-gray-600 dark:text-gray-300">
