...
export const CustomsCalculator = () => {
    ...
    const calculateSanctionedJPShipping = (priceJPY) => {
    ...
    const calculateCustomsDuty = (priceEur, volumeCc, age) => {
        if (age === 'new') {
            if (priceEur <= 8500) {
    ...
    const getCustomsFee = (customsValue) => {
    ...
    const checkSanctioned = (volume, type) => {
    ...
    const handleEngineVolumeChange = (value) => {
